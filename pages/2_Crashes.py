...
def show_gif_with_text(gif_path, display_time=2):
    ...
    placeholder.empty()
show_gif_with_text("../planeCrash.gif", display_time=3)
...
def load_data():
    ...
    data = pd.read_csv('/Users/asvithavibeeshanan/Downloads/AirSafe-Analytics-Delays-Crashes/Plane Crashes.csv')
    return data
...
df, available_year_groups = load_and_process_data('/Users/asvithavibeeshanan/Downloads/AirSafe-Analytics-Delays-Crashes/Plane Crashes.csv')
